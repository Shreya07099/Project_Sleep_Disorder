...
Still needs work
AI Disclosure: Generative AI has been used to technically assist  in the  codes of the preprocessing process of applying SMOTE and under sampling, and professional formatting of the README file, but rest assured the author understands each and every concept applied and used and the results
